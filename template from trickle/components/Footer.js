      ...
      <footer className="bg-[var(--text-primary)] text-white py-12" data-name="footer" data-file="components/Footer.js">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-2xl font-bold mb-4 text-[var(--primary-color)]">KLOSET</h3>
              <p className="text-gray-400 text-sm">Rent designer fashion for every special occasion.</p>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
            <p>© 2026 Kloset. All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
